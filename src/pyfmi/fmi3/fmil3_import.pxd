...
#     #ctypedef void(*fmi2_callback_logger_ft)(fmi3_component_t c,fmi3_string_t instanceName, fmi3_status_t status, fmi3_string_t category,fmi3_string_t message,...)
#     ctypedef void(*fmi2_callback_logger_ft)(fmi2_component_environment_t c,fmi3_string_t instanceName, fmi3_status_t status, fmi3_string_t category,fmi3_string_t message,...)
#     ctypedef void(*fmi2_step_finished_ft)(fmi2_component_environment_t env, fmi3_status_t status)
...
#         jm_string name
    ...
    # TODO: Should this be taken from fmil_import?
...
#         pass
#     ctypedef fmi2_xml_type_definitions_t fmi3_import_type_definitions_t
...
#     # basic
    ...
    # )
    # TODO: This is outdated on current FMIL master
    FMIL.jm_status_enu_t fmi3_import_instantiate_model_exchange(
        fmi3_import_t* fmu, 
        fmi3_string_t instanceName, 
        fmi3_string_t resourcePath, 
...
#     char* fmi2_import_get_types_platform(fmi3_import_t*)
#     int fmi2_import_setup_experiment(fmi3_import_t* fmu, fmi3_boolean_t toleranceDefined, fmi2_real_t tolerance,fmi2_real_t startTime, fmi3_boolean_t stopTimeDefined,fmi2_real_t stopTime)
#     int fmi2_import_do_step(fmi3_import_t*, fmi2_real_t, fmi2_real_t, fmi3_boolean_t) nogil
#     int fmi2_import_completed_integrator_step(fmi3_component_t, fmi3_boolean_t, fmi3_boolean_t*, fmi3_boolean_t*)
...
#     int fmi2_import_enter_event_mode(fmi3_import_t* fmu)
    FMIL.jm_status_enu_t fmi3_import_enter_continuous_time_mode(fmi3_import_t* fmu)

#     # misc
#     int fmi2_import_set_debug_logging(fmi3_import_t*, fmi3_boolean_t, size_t, fmi3_string_t*)
#     int fmi2_import_reset(fmi3_import_t* fmu)
#     int fmi2_import_cancel_step(fmi3_import_t*)
#     int fmi2_import_new_discrete_states(fmi3_import_t* fmu, fmi2_event_info_t* eventInfo)
#     char* fmi2_import_get_version(fmi3_import_t*)

#     # setting
#     int fmi2_import_set_time(fmi3_import_t*, fmi2_real_t)
#     int fmi2_import_set_integer(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi2_integer_t *)
#     int fmi2_import_set_real(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi2_real_t *)
#     int fmi2_import_set_boolean(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi3_boolean_t *)
#     int fmi2_import_set_string(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi3_string_t *)

#     int fmi2_import_set_continuous_states(fmi3_import_t*, fmi2_real_t *, size_t)
#     int fmi2_import_set_real_input_derivatives(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi2_integer_t *, fmi2_real_t *)

#     # getting
#     int fmi2_import_get_integer(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi2_integer_t *)
#     int fmi2_import_get_real(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi2_real_t *)
#     int fmi2_import_get_string(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi3_string_t *)
#     int fmi2_import_get_boolean(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi3_boolean_t *)

#     int fmi2_import_get_derivatives(fmi3_import_t*, fmi2_real_t *, size_t)
#     int fmi2_import_get_event_indicators(fmi3_import_t*, fmi2_real_t *, size_t)
#     int fmi2_import_get_continuous_states(fmi3_import_t*, fmi2_real_t *, size_t)
#     int fmi2_import_get_nominals_of_continuous_states(fmi3_import_t* fmu, fmi2_real_t *, size_t nx)
#     int fmi2_import_get_directional_derivative(fmi3_import_t*, fmi2_value_reference_t*, size_t, fmi2_value_reference_t*, size_t, fmi2_real_t*, fmi2_real_t*)
#     int fmi2_import_get_real_output_derivatives(fmi3_import_t*, fmi2_value_reference_t *, size_t, fmi2_integer_t *, fmi2_real_t *)

#     int fmi2_import_get_status(fmi3_import_t* fmu, const fmi2_status_kind_t s, fmi3_status_t* value)
#     int fmi2_import_get_integer_status(fmi3_import_t*, int, fmi2_integer_t *)
#     int fmi2_import_get_real_status(fmi3_import_t*, int, fmi2_real_t *)
#     int fmi2_import_get_boolean_status(fmi3_import_t*, int, fmi3_boolean_t *)
#     int fmi2_import_get_string_status(fmi3_import_t*, int, fmi3_string_t *)

#     # save states
#     int fmi2_import_get_fmu_state(fmi3_import_t*, fmi2_FMU_state_t *)
#     int fmi2_import_set_fmu_state(fmi3_import_t*, fmi2_FMU_state_t)
#     int fmi2_import_free_fmu_state(fmi3_import_t*, fmi2_FMU_state_t *)
#     int fmi2_import_serialized_fmu_state_size(fmi3_import_t*, fmi2_FMU_state_t, size_t *)
#     int fmi2_import_serialize_fmu_state(fmi3_import_t*, fmi2_FMU_state_t, fmi2_byte_t *, size_t)
#     int fmi2_import_de_serialize_fmu_state(fmi3_import_t*, fmi2_byte_t *, size_t, fmi2_FMU_state_t *)

#     #FMI HELPER METHODS (2.0)
#     char* fmi2_import_get_GUID(fmi3_import_t*)
#     char* fmi2_import_get_description(fmi3_import_t*)
#     char* fmi2_import_get_author(fmi3_import_t*)
#     char* fmi2_import_get_license(fmi3_import_t*)
#     char* fmi2_import_get_generation_tool(fmi3_import_t*)
#     char* fmi2_import_get_generation_date_and_time(fmi3_import_t*)
#     fmi2_variable_naming_convension_enu_t fmi2_import_get_naming_convention(fmi3_import_t*)
    const char* fmi3_import_get_model_name(fmi3_import_t*)

    fmi3_fmu_kind_enu_t fmi3_import_get_fmu_kind(fmi3_import_t*)

#     unsigned int fmi2_import_get_capability(fmi3_import_t*, fmi2_capabilities_enu_t)
#     double fmi2_import_get_default_experiment_stop(fmi3_import_t*)
#     double fmi2_import_get_default_experiment_start(fmi3_import_t*)
#     double fmi2_import_get_default_experiment_step(fmi3_import_t*)
...
#     size_t fmi2_import_get_number_of_event_indicators(fmi3_import_t*)
#     size_t fmi2_import_get_number_of_continuous_states(fmi3_import_t*)
#     fmi2_import_variable_list_t* fmi2_import_get_outputs_list(fmi3_import_t*)
#     void fmi2_import_get_outputs_dependencies(fmi3_import_t* fmu, size_t** startIndex, size_t** dependency, char** factorKind)
#     void fmi2_import_get_derivatives_dependencies(fmi3_import_t* fmu, size_t** startIndex, size_t** dependency, char** factorKind)
...
#     double fmi2_import_get_default_experiment_tolerance(fmi3_import_t*)
...
#     fmi2_import_variable_list_t* fmi2_import_get_derivatives_list(fmi3_import_t* fmu)
...
#     fmi2_import_variable_list_t * fmi2_import_get_variable_aliases(fmi3_import_t*, fmi2_import_variable_t*)
#     fmi2_import_variable_list_t * fmi2_import_get_variable_list(fmi3_import_t*, int)
#     fmi2_import_variable_typedef_t * fmi2_import_get_variable_declared_type(fmi2_import_variable_t*)
#     fmi3_boolean_t fmi2_import_get_boolean_variable_start(fmi2_import_bool_variable_t *)
...
#     char* fmi2_import_get_log_category(fmi3_import_t*, size_t)
...
#     fmi2_import_variable_t* fmi2_import_get_variable_by_name(fmi3_import_t*, char*)
#     double fmi2_import_get_real_type_min(fmi2_import_real_typedef_t *)
#     fmi2_import_variable_t* fmi2_import_get_variable_by_vr(fmi3_import_t*, fmi2_base_type_enu_t, fmi2_value_reference_t)
#     fmi2_real_t fmi2_import_get_real_variable_max(fmi2_import_real_variable_t *)
#     fmi2_import_variable_list_t * fmi2_import_get_derivatives_list(fmi3_import_t*)
...
#     size_t fmi2_import_get_log_categories_num(fmi3_import_t*)
#     char* fmi2_import_get_type_quantity(fmi2_import_variable_typedef_t *)
#     char* fmi2_import_get_unit_name(fmi2_import_unit_t *)
#     fmi2_import_variable_t* fmi2_import_get_variable_alias_base(fmi3_import_t*, fmi2_import_variable_t*)
...
#     char* fmi2_import_get_copyright(fmi3_import_t*)
...
#     char* fmi2_import_get_model_version(fmi3_import_t*)
#     fmi3_boolean_t fmi2_import_get_real_variable_relative_quantity(fmi2_import_real_variable_t* v)
#     fmi3_boolean_t fmi2_import_get_real_variable_unbounded(fmi2_import_real_variable_t* v)

#     # unsorted & unused!!!
#     size_t fmi2_import_get_derivative_index(fmi2_import_variable_t*)
#     void  fmi2_default_callback_logger(fmi3_component_t c, fmi3_string_t instanceName, fmi3_status_t status, fmi3_string_t category, fmi3_string_t message, ...)
...
#     fmi2_import_variable_typedef_t * fmi2_import_get_typedef(fmi3_import_type_definitions_t *, unsigned int)
...
#     void fmi2_log_forwarding_v(fmi3_component_t, fmi3_string_t, int, fmi3_string_t, fmi3_string_t, __va_list_tag *)
...
#     int fmi2_import_clear_last_error(fmi3_import_t*)
#     unsigned int fmi2_import_get_type_definition_number(fmi3_import_type_definitions_t *)
...
#     fmi2_import_unit_definitions_t * fmi2_import_get_unit_definitions(fmi3_import_t*)
#     void fmi2_import_get_dependencies_derivatives_on_inputs(fmi3_import_t*, size_t * *, size_t * *, char* *)
#     fmi2_import_variable_list_t * fmi2_import_prepend_to_var_list(fmi2_import_variable_list_t *, fmi2_import_variable_t*)
#     void fmi2_import_set_debug_mode(fmi3_import_t*, int)
#     char* fmi2_import_get_vendor_name(fmi3_import_t*, size_t)
#     double fmi2_import_get_SI_unit_offset(fmi2_import_unit_t *)
#     void fmi2_import_expand_variable_references(fmi3_import_t*, char*, char*, size_t)
...
#     fmi2_import_variable_list_t * fmi2_import_create_var_list(fmi3_import_t*, fmi2_import_variable_t*)
...
#     void fmi2_import_get_dependencies_outputs_on_states(fmi3_import_t*, size_t * *, size_t * *, char* *)
#     char* fmi2_base_type_to_string(fmi2_base_type_enu_t)
#     size_t fmi2_import_get_vendors_num(fmi3_import_t*)
#     void fmi2_import_collect_model_counts(fmi3_import_t*, fmi2_import_model_counts_t *)
#     char* fmi2_dependency_factor_kind_to_string(fmi2_dependency_factor_kind_enu_t)
#     char* fmi3_status_to_string(int)
#     char* fmi2_import_get_model_standard_version(fmi3_import_t*)
...
#     void fmi2_import_get_dependencies_derivatives_on_states(fmi3_import_t*, size_t * *, size_t * *, char* *)
#     char* fmi2_naming_convention_to_string(fmi2_variable_naming_convension_enu_t)
#     fmi3_import_type_definitions_t * fmi2_import_get_type_definitions(fmi3_import_t*)
#     char* fmi2_initial_to_string(fmi2_initial_enu_t)
#     char* fmi2_capability_to_string(fmi2_capabilities_enu_t)
#     fmi2_import_variable_list_t * fmi2_import_get_states_list(fmi3_import_t*)
